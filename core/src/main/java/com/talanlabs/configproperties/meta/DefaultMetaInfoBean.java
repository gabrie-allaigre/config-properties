...
public class DefaultMetaInfoBean<E> extends MetaInfoBean<E> {

    private Set<String> propertyNames;
    private Map<String, PropertyInfo> propertyInfoMap;

    public DefaultMetaInfoBean(Class<E> beanClass) {
        super(beanClass);
    ...
    private void init() {
        ...
        this.propertyNames = Collections.unmodifiableSet(temp);
    }
    ...
    public E createInstance() {
        try {
            ...
            throw new MetaBeanException("Failed to create instance for bean=" + beanClass, e);
        }
    }
    ...
    public <A extends Annotation> A getPropertyAnnotation(String propertyName, Class<A> annotationClass) {
        checkProperty(propertyName);
        return this.propertyInfoMap.get(propertyName).getAnnotation(annotationClass);
    }
        ...
        Object getValue(Object bean) {
            ...
            if (this.readMethod != null) {
                try {
                    ...
                    throw new MetaBeanException("Failed to get value in " + propertyName + " for " + beanClass, e);
                }
            } else if (this.field != null) {
                try {
        ...
        void setValue(Object bean, Object value) {
            ...
            if (this.writeMethod != null) {
                try {
                    ...
                    throw new MetaBeanException("Failed to set value in " + propertyName + " for " + beanClass, e);
                }
            } else if (this.field != null) {
                try {
